      ...
      <Tabs defaultValue="social" className="space-y-6">
        ...
        <TabsContent value="brands" className="space-y-4">
          <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] rounded-xl p-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
              <p className="text-blue-400 text-sm">
                <strong>✏️ Édition rapide :</strong> Modifiez directement les marques des puzzles. Les changements sont visibles dans toute l'application.
              </p>
            </div>
            
            <div className="space-y-2 max-h-[700px] overflow-y-auto">
              {[...puzzles].sort((a, b) => (a.brand || '').localeCompare(b.brand || '')).map((puzzle, index) => {
                const isEditing = editingPuzzle === puzzle.id;
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="text-white font-medium line-clamp-1">{puzzle.title}</h4>
                        <p className="text-white/50 text-xs">
                          {puzzle.piece_count} pièces • {puzzle.category_tag}
                        </p>
                      </div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="text-center min-w-[150px]">
                            <div className="text-orange-400 font-bold">
                              {puzzle.brand || '❌ Non renseigné'}
                            </div>
                            <div className="text-white/50 text-xs">Marque</div>
                          </div>
                        )}
