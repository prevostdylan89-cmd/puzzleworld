...
Deno.serve(async (req) => {
  try {
    ...
    return Response.json({ success: true, message: `${addedCount} puzzles restaurés sur ${puzzles.length} trouvés dans Firebase!`, restored: addedCount, total: puzzles.length });
  } catch (error) {
